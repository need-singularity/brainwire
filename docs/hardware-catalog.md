...
| 제품 | 가격 | 스펙 | 구매처 | 타겟 변수 |
|------|------|------|--------|-----------|
| **시판 TENS (4ch)** | ~$25 | 2-150Hz, 0-80mA, 패드 | 약국/쿠팡 | V2,V11 |
| **OMRON HV-F128** | ~$50 | 4ch, 12프로그램 | 약국 | V2,V11 |
| **iReliev ET-7070** | ~$80 | TENS+EMS, BLE, 앱 | Amazon | V2,V11 |

**주파수별 효과:**
```
  2-4Hz (low)     → endorphin + eCB release → V2(eCB↑), V11(Body↑)
  50-100Hz (high)  → gate control → V11(Body↑) 즉시 효과
  burst mode       → 혼합 효과
```
...
| 제품 | 가격 | 스펙 | 구매처 | 타겟 변수 |
|------|------|------|--------|-----------|
| **전기 온열패드** | ~$20 | 30-50°C, 타이머 | 다이소/쿠팡 | V2,V11 |
| **온열 가중담요** | ~$60 | 7kg + 가열 | 쿠팡 | V2,V4,V11 |
| **적외선 램프** | ~$25 | 원적외선, 국소 가열 | 약국 | V2,V11 |
